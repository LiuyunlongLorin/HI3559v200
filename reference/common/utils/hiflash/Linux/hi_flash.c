...
#include "hi_flash.h"
#include "nand.h"
#include "../Linux/spi_raw.h"
#include "../Linux/nand_raw.h"
#include "../Linux/emmc_raw.h"
...
HI_S64 HI_Flash_Erase64(HI_HANDLE hFlash, HI_U64 u64Address, HI_U64 u64Len)
{
    ...
    ret = (HI_S64)gFlashInfo[hFlash].pFlashopt->raw_erase((HI_S32)(HI_SL)gFlashInfo[hFlash].fd, (unsigned long long)StartAddr, u64Len, gFlashInfo[hFlash].OpenAddr, LimitLeng);
    HI_INFO_FLASH("end.\n");
    (HI_VOID)pthread_mutex_unlock(&gFlashMutex);
