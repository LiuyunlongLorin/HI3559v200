...
HI_S32 main()
{
    ...
    s32Ret = HI_PDT_INIPARAM_LoadCamMediaCfg(s_stPARAMCfg.astCamMediaCfg);
    ...
    MLOGD("CAM  UnitSize[%lu], Cnt[%d]\n",
        (HI_UL)sizeof(PDT_PARAM_CAM_MEDIA_CFG_S), HI_PDT_MEDIA_VCAP_DEV_MAX_CNT);

    MLOGD("CAM MediaMode Comm Size[%lu]\n", (HI_UL)sizeof(PDT_PARAM_CAM_MEDIAMODE_COMM_CFG_S));
    MLOGD("CAM MediaMode Spec UnitSize[%lu], Cnt[%d]\n",
