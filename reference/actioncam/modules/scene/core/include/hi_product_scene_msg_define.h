...
typedef enum tagMSG_PDT_SCENE_CMD_E
{
    ...
    MSG_PDT_SCENE_GETPOSTPROCESSINFO,
#endif
    MSG_PDT_SCENE_GETLONGEXPINFO,
    MSG_PDT_SCENE_REFRESHPHOTOPIPE,
    MSG_PDT_SCENE_GETLONGEXPGAIN,
    MSG_PDT_SCENE_GETLONGEXPTIME,
...
#ifdef CFG_POST_PROCESS
    MSG_PDT_SCENE_LOCKAE,
    MSG_PDT_SCENE_LOCKAWB,
    MSG_PDT_SCENE_LOCKHDR,
#endif
