...
HI_S32 PDT_SCENE_SetVI3DNRParam(HI_HANDLE ModHdl, HI_U8 u8Index, HI_PDT_SCENE_PIPE_PARAM_S* pstSceneParam)
{
    ...
    stNRX.stNRXParamV2.stNRXAutoV2.pau32ISO = (HI_U32*)malloc(sizeof(HI_U32) *  \
        HI_PDT_SCENE_3DNR_MAX_COUNT);
    if(NULL == stNRX.stNRXParamV2.stNRXAutoV2.pau32ISO)
    {
        return HI_FAILURE;
    }

    stNRX.stNRXParamV2.stNRXAutoV2.pastNRXParamV2 = (VI_PIPE_NRX_PARAM_V2_S*)malloc(sizeof(VI_PIPE_NRX_PARAM_V2_S) *  \
        HI_PDT_SCENE_3DNR_MAX_COUNT);
    if(NULL == stNRX.stNRXParamV2.stNRXAutoV2.pastNRXParamV2)
    {
        if(NULL != stNRX.stNRXParamV2.stNRXAutoV2.pau32ISO)
        {
            HI_APPCOMM_SAFE_FREE(stNRX.stNRXParamV2.stNRXAutoV2.pau32ISO);
        }
        return HI_FAILURE;
    }
    ...
    if (HI_SUCCESS != s32Ret)
    {
        ...
        HI_APPCOMM_SAFE_FREE(stNRX.stNRXParamV2.stNRXAutoV2.pau32ISO);
        HI_APPCOMM_SAFE_FREE(stNRX.stNRXParamV2.stNRXAutoV2.pastNRXParamV2);
        return HI_FAILURE;
    }
...
HI_S32 PDT_SCENE_SetVPSS3DNRParam(HI_HANDLE ModHdl, HI_U8 u8Index, HI_PDT_SCENE_PIPE_PARAM_S* pstSceneParam)
{
    ...
    s32Ret = HI_MPI_VPSS_GetGrpAttr(ModHdl, &stVpssGrpAttr);
    if (HI_SUCCESS != s32Ret)
    {
        MLOGE("HI_MPI_VPSS_GetGrpAttr failed.");
        return HI_FAILURE;
    }
    stVpssGrpAttr.bNrEn = HI_TRUE;
    s32Ret = HI_MPI_VPSS_SetGrpAttr(ModHdl, &stVpssGrpAttr);
    if (HI_SUCCESS != s32Ret)
    {
        MLOGE("HI_MPI_VPSS_GetGrpAttr failed.");
        return HI_FAILURE;
    ...
    stNRX.stNRXParam_V2.stNRXAuto.pau32ISO = (HI_U32*)malloc(sizeof(HI_U32) *  \
        HI_PDT_SCENE_3DNR_MAX_COUNT);
    if(NULL == stNRX.stNRXParam_V2.stNRXAuto.pau32ISO)
    {
        return HI_FAILURE;
    }

    stNRX.stNRXParam_V2.stNRXAuto.pastNRXParam = (VPSS_NRX_V2_S*)malloc(sizeof(VPSS_NRX_V2_S) *  \
        HI_PDT_SCENE_3DNR_MAX_COUNT);
    if(NULL == stNRX.stNRXParam_V2.stNRXAuto.pastNRXParam)
    {
        if(NULL != stNRX.stNRXParam_V2.stNRXAuto.pau32ISO)
        {
            HI_APPCOMM_SAFE_FREE(stNRX.stNRXParam_V2.stNRXAuto.pau32ISO);
        }
        return HI_FAILURE;
    }
    ...
    if (HI_SUCCESS != s32Ret)
    {
        ...
        HI_APPCOMM_SAFE_FREE(stNRX.stNRXParam_V2.stNRXAuto.pau32ISO);
        HI_APPCOMM_SAFE_FREE(stNRX.stNRXParam_V2.stNRXAuto.pastNRXParam);
        return HI_FAILURE;
    }
#endif
