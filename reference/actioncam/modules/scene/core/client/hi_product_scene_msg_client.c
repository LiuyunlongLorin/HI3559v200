...
static HI_S32 MSG_PDT_SCENE_ReduceFrameCallback(HI_S32 s32MsgID, const HI_VOID* pvRequest, HI_U32 u32ReqLen,
...
static HI_S32 MSG_PDT_SCENE_AddFrameCallback(HI_S32 s32MsgID, const HI_VOID* pvRequest, HI_U32 u32ReqLen,
    HI_MSG_PRIV_DATA_S* pstPrivData, HI_VOID** ppvResponse, HI_U32* pu32RespLen, HI_VOID* pvUserData)
{
    HI_S32 s32Ret = HI_SUCCESS;
