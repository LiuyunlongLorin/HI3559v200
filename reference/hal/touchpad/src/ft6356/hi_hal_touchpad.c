...
/** macro define */
#define HAL_TOUCHPAD_KO_PATH  HI_APPFS_KOMOD_PATH"/ft_6356.ko"
...
static HI_VOID HAL_TOUCHPAD_PinoutInit(HI_VOID)
{
    ...
    himm(0x01F0010D0 ,0x1402); /**< #pinout reuse as i2c*/
    himm(0x01F0010D4 ,0x1402); /**< #pinout reuse as i2c*/
#else
    himm(0x01F0010DC ,0x1402); /**< #pinout reuse as i2c*/
    himm(0x01F0010E0 ,0x1402); /**< #pinout reuse as i2c*/
#endif

    himm(0x01F0010D8 ,0x1400); /**< #pinout reuse as gpio, used for tp reset*/
    himm(0x01F001040 ,0x1400); /**< #pinout reuse as gpio, used for interupt*/
