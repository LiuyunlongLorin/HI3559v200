...
/** macro define */
#define HAL_TOUCHPAD_KO_PATH        HI_APPFS_KOMOD_PATH"/ft_6236.ko"
...
static HI_VOID HAL_TOUCHPAD_PinoutInit(HI_VOID)
{
    ...
    himm(0x047B8008 ,0x1a00);
    himm(0x047B8024 ,0x1000);
    himm(0x040580c4 ,0x1073);
    himm(0x040580c8 ,0x1073);
#elif defined(BOARD_DEMB) && (defined(HI3556AV100) || defined(HI3519AV100))
    himm(0x0405806c ,0x1073);
    himm(0x04058070 ,0x1073);
