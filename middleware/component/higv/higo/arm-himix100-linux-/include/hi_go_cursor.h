...
HI_S32 HI_GO_InitCursor(HI_VOID);
...
HI_S32 HI_GO_DeinitCursor(HI_VOID);
...
\see \n
*/
HI_S32  HI_GO_AttchCursorToLayer(HIGO_LAYER_E hLayer);
...
\see \n
*/
HI_S32  HI_GO_DetachCursorFromLayer(HIGO_LAYER_E hLayer);
/** @} */  /** <!-- ==== API declaration end ==== */
#ifdef __cplusplus
}
#endif
