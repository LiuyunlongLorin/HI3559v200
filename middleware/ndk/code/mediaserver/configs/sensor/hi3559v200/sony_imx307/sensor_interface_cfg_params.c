...
static const HI_MAPI_SENSOR_MODE_S g_Sensor_Mode[] = {
    ...
    /* SENSOR_MODE_1080p_30FPS_WDR  frameRate:[1.0-30] */
    {
        .s32Width = 1920,
        .s32Height = 1080,
        .u8SnsMode = 0,
...
static HI_MAPI_COMBO_DEV_ATTR_S g_Sensor_Cfg = {
    ...
    .pSensorObj = &stSnsImx307Obj,
#elif defined CFG_LANE_DIVIDE_MODE_1
    .pSensorObj = &stSnsImx307_2l_Obj,
#endif
    .s32SensorType = IMX307,
    ...
    .aLaneId = {
        ...
        {
            { 0, 2, -1, -1 }, /* 1080p@30FPS */
            { 0, 2, -1, -1 }, /* 1080p@30FPS_wdr */
        },

        /* mipi_dev1 */
        {
            { 0, 1, -1, -1 }, /* 1080p@30FPS */
            { 0, 1, -1, -1 }, /* 1080p@30FPS_wdr */
        }
#endif
    },
};
