...
/*codes relate to  __kernel_rem_pio2*/
...
//codes relate to __kernel_tandf
...
{
    int jz,jx,jv,jp,jk,carry,n,iq[20]={0},i,j,k,m,q0,ih;
...
recompute:
    ...
    switch(prec) {
        ...
        if(ih==0) {
            y[0] =  fq[0]; y[1] =  fq[1]; y[2] =  fw; /*lint !e661 !e662*/
        } else {
            y[0] = -fq[0]; y[1] = -fq[1]; y[2] = -fw; /*lint !e661 !e662*/
        }
    }
