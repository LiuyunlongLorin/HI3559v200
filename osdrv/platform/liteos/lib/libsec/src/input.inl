        ...
        while (*fmt) /*lint !e944*/
        {
            if (_T_S('%') == *fmt)
            {
                ...
                while (!doneFlag)
                {
                    ...
                    else if(_T_S('l') == spec || _T_S('w') == spec)
                    {
                        ++wideChar;
                        continue;
                    }
                ...
                spec = *fmt | (_T_S('a') - _T_S('A'));

                if (!(spec == _T_S('c') || spec == _T_S('s') || spec == LEFT_BRACKET))
                {
                    return;/*first argument is not a string type*/
                }

                if ((buffer !=NULL) && (*buffer != _T_S('\0')) && (spec != _T_S('s')))
                {
            ...
            */
                ...
                if( LEFT_BRACKET == spec)
                {
                    ...
                    /*2014 3.14 LSD add _T_S('\0') != *scanptr*/
                    while ((_T_S('\0') != *fmt) && (_T_S(']') != *fmt))
                    {
                        ++fmt;
                    }
                    if (!*fmt)
    ...
    while (format != NULL && *format) /*lint !e944*/
    {
        ...
        if (_T_S('%') == *format)
        {
            ...
            while (!doneFlag)
            {
                ...
                {
                    ++widthSet;
                    width = (int)MUL10(width) + (comChr - _T_S('0')); /*lint !e701*/
                }
                else
                {
                    switch (comChr)
                    {
                        ...
                        case _T_S('I'):
                            ...
                            else if ( (*(format + 1) == _T_S('3')) &&
                                      (*(format + 2) == _T_S('2')) )
                            {
                                format += 2;
                                break;
                            }
                            else if ( (*(format + 1) == _T_S('d')) ||
                                      (*(format + 1) == _T_S('i')) ||
                                      (*(format + 1) == _T_S('o')) ||
                                      (*(format + 1) == _T_S('x')) ||
                                      (*(format + 1) == _T_S('X')) )
            ...
            if (!wideChar)
            {
                ...
                if ((*format == _T_S('S')) || (*format == _T_S('C')))
#if defined(_UNICODE) && (defined(COMPATIBLE_WIN_FORMAT))
                {    --wideChar;}
                else
                { ++wideChar; }
            ...
            comChr = *format | (_T_S('a') - _T_S('A'));

            if (_T_S('n') != comChr)
            {
                if (_T_S('c') != comChr && LEFT_BRACKET != comChr)
                {
                    ch = EAT_WHITE();
                }
                else
            ...
            if (!widthSet || width)
            {
                if (!suppress && (comChr == _T_S('c') || comChr == _T_S('s') || comChr == LEFT_BRACKET))
                {
                    ...
                    case LEFT_BRACKET :   /* scanset */
                        ...
                        if (LEFT_BRACKET == comChr) /*lint !e774*/
                        {
                            if (_T_S(']') == *scanptr)
                            {
                                ...
                                table[ _T_S(']') >> 3] = 1 << (_T_S(']') & 7);

                            }
                        }

                        /*2014 3.14 LSD add _T_S('\0') != *scanptr*/
                        while (_T_S('\0') != *scanptr && _T_S(']') != *scanptr)
                        {
                        ...
                        if (!*scanptr)
                        {
                            ...
                            {
                                *(_TCHAR*)pointer = _T_S('\0');  /*lint !e613*/
                            }
...
END_MASK_MSVC_SECURE_CRT_WARNING
                    ...
                    case _T_S('i') :      /* could be d, o, or x */

                        comChr = _T_S('d'); /* use as default */
                    /*lint -fallthrough*/
                    case _T_S('x'):
                        if (_T_S('-') == ch)
                        {
                        ...
                        if (_T_S('0') == ch)
                        {
                            ...
                            if (_T_S('x') == (_TCHAR)(ch = INC()) || _T_S('X') == (_TCHAR)ch)
                            {
                                ch = INC();
                                if (widthSet)
                                {
                    ...
                    getnum:
                        ...
                        if ( integer64 )
                        {
                            ...
                            while (!doneFlag)
                            {
                                ...
                                if (_T_S('x') == comChr || _T_S('p') == comChr)
                                    /* coverity[returned_null] */
                                ...
                                /* coverity[returned_null] */
                                    ...
                                    else /* _T_S('d') == comChr */
                                    {
                                        ...
                                        if (num64 == MAX_64BITS_VALUE_CUT_LAST_DIGIT)
                                        {
                                            ...
                                            if (num64as < (UINT64T)(ch - _T_S('0'))) /*lint !e574 !e571*/
                                            {
                                                beyondMax = 1;
                                            }
                                        }
...
#if (defined(COMPATIBLE_LINUX_FORMAT) && !(defined(__UNIX)))
                            {
                                if ((_T_S('d') == oricomChr) || (_T_S('i') == oricomChr))
                                {
...
#endif  /* _INTEGRAL_MAX_BITS >= 64    */
                        if (_T_S('F') == comChr) /* expected ':' in long pointer */
                        {
                            started = 0;
                        }
                    ...
                    case _T_S('e') :
                        /* case _T_S('E') : */
                    case _T_S('f') :
                    case _T_S('g') : /* scan a float */
                        /* case _T_S('G') : */
                        nFloatStrUsed = 0;

                        if (_T_S('-') == ch)
                        {
                            pFloatStr[nFloatStrUsed++] = _T_S('-');
                        ...
                        if (started && (_T_S('e') == ch || _T_S('E') == ch) && width--)
                        {
                            pFloatStr[nFloatStrUsed++] = _T_S('e');
                            if (__check_float_string(nFloatStrUsed,
                                                     &nFloatStrSz,
                                                     &pFloatStr,
                                                     floatstring,
                        ...
                        if (started)
                        {
                            ...
                            {
                                ++count;
                                pFloatStr[nFloatStrUsed] = _T_S('\0');
#ifdef _UNICODE
                                {
        ...
        if ( (_TEOF == ch) && ((*format != _T_S('%')) || (*(format + 1) != _T_S('n'))) )
        {
            break;
        }
...
error_return:
    ...
    return count;  /*lint !e593 !e438*/
}

static _TINT  _hextodec ( _TCHAR chr)/*lint !e129 !e10 */
{
    /* coverity[returned_null] */
    return _IS_DIGIT(chr) ? chr : ((chr & ~(_T_S('a') - _T_S('A'))) - _T_S('A')) + 10 + _T_S('0');/*lint !e40 !e10 !e48 !e409*/
}
