...
#define EMMC_PHY_INIT_CTRL	0x12160004
#define PHY_INIT_EN         0x1
#define PHY_ZCAL_EN			(0x1 << 3)

#define EMMC_PHY_IOCTL_RONSEL_1_0   0x12160264
#define RG_EMMC_RONSEL1             0x7ff
#define RG_EMMC_RONSEL0             0x7ff
#define EMMC_PHY_IOCTL_OD_RONSEL_2  0x12160268
#define EMMC_PHY_IOCTL_IOE			0x1216026c
#define NAND_IO_EN					0x00ff00ff

static void nand_io_config(void)
{
...
static void hifmc100_nand_clk_enable(int enable)
{
    unsigned int old_val, regval;
