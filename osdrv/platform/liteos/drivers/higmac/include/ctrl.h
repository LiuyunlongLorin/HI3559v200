...
#define HIGMAC_CSUM_ENABLE    1
#define HIGMAC_CSUM_DISABLE   0
#if LWIP_TX_CSUM_OFFLOAD /*lint !e553*/
#define HIGMAC_IPV4_VERSION_HW 0
#define HIGMAC_IPV6_VERSION_HW 1
#define HIGMAC_TRANS_TCP_TYPE_HW 0
#define HIGMAC_TRANS_UDP_TYPE_HW 1
#endif
