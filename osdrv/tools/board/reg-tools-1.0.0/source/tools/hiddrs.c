...
static void print_usage(void)
{
	...
	printf("      \"0\" as default.\n");
	printf("  -f, --freq\n");
	printf("      one ddrc freq, one chip, please set the freq referring to the chip.\n");
	printf("      \"466\" as default.\n");
	printf("  -w, --width\n");
	printf("      set the single channel's bit-width referring to the chip. \"32\" or \"16\".\n");
