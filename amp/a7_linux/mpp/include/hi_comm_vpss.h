...
typedef struct hiVPSS_GRP_ATTR_S {
    HI_U32                     u32MaxW;           /* RW; Range: Hi3559AV100 = [64, 16384] | Hi3519AV100 = [64, 8192] | Hi3516CV500 = [64, 2304] | Hi3516AV300 = [64, 3840] | Hi3516DV300 = [64, 2688] | Hi3556V200 = [64, 4608] | Hi3559V200 = [64, 4608] | Hi3516EV200 = [64, 4096]; Width of source image. */
    HI_U32                     u32MaxH;           /* RW; Range: Hi3559AV100 = [64, 16384] | Hi3519AV100 = [64, 8192] | Hi3516CV500 = [64, 2304] | Hi3516AV300 = [64, 3840] | Hi3516DV300 = [64, 2688] | Hi3556V200 = [64, 4608] | Hi3559V200 = [64, 4608] | Hi3516EV200 = [64, 4096]; Height of source image. */
...
typedef struct hiVPSS_CHN_ATTR_S {
    ...
    HI_U32              u32Width;           /* RW; Range: Hi3559AV100 = [64, 16384] | Hi3519AV100 = [64, 8192] | Hi3516CV500 = [64, 8192] | Hi3516AV300 = [64, 8192] | Hi3516DV300 = [64, 8192] | Hi3556V200 = [64, 8192] | Hi3559V200 = [64, 8192] | Hi3516EV200 = [64, 4096]; Width of target image. */
    HI_U32              u32Height;          /* RW; Range: Hi3559AV100 = [64, 16384] | Hi3519AV100 = [64, 8192] | Hi3516CV500 = [64, 8192] | Hi3516AV300 = [64, 8192] | Hi3516DV300 = [64, 8192] | Hi3556V200 = [64, 8192] | Hi3559V200 = [64, 8192] | Hi3516EV200 = [64, 4096]; Height of target image. */
...
/* Only used for Hi3519AV100 */
typedef struct {
    HI_U8  SPN6 : 3, SFR  : 5;   /* SPN6; Range: [0,   4];  The selection of filters to be mixed for NO.6 filter. */
    /* SFR ; Range: [0,  31];  The relative NR strength to the SFi and SFk filter. */
    HI_U8  SBN6 : 3, PBR6 : 5;   /* SBN6; Range: [0,   4];  The selection of filters to be mixed for NO.6 filter. */
