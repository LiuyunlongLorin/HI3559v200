...
static char *sensor_type0 = "imx327"; /* imx335 imx327  imx290 imx377 imx458 ov12870 gc2053*/
...
static HI_S32 Serdes_init(void)
{
    extern int serdes_mod_init(void);
    return serdes_mod_init();
}
#endif
...
#if CONFIG_HI_PM_SUPPORT==1
    ret = PM_init();
    if (ret != 0)
    {
        printf("pm mode init error.\n");
    }
#endif
