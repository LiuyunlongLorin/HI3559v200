...
void VI_Chn_Dump_HandleSig(HI_S32 signo)
{
    if(u32SignalFlag)
    {
        exit(-1);
...
HI_VOID* SAMPLE_MISC_ViDump(VI_PIPE Pipe, VI_CHN Chn, HI_U32 u32FrameCnt, HI_U32 u32ByteAlign)
{
    ...
    snprintf(szYuvName, 128, "/nfs/vi_pipe%d_chn%d_w%d_h%d_%s_%s_%s_%d_%d.yuv", Pipe, Chn,
...
#ifdef __HuaweiLite__
HI_S32 vi_chn_dump(int argc, char* argv[])
#else
