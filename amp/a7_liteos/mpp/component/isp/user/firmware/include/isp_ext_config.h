...
//static __inline HI_VOID hi_ext_system_gamma_inseg_write(VI_PIPE ViPipe, HI_U16 u16Index, HI_U16 data)
//{
//    IOWR_16DIRECT(VREG_GAMMA_BASE(ViPipe) + 0x810 + (u16Index * sizeof(HI_U16)), data);
//}
//
//static __inline HI_U16 hi_ext_system_gamma_inseg_read(VI_PIPE ViPipe,  HI_U16 u16Index)
//{
//    return (IORD_16DIRECT(VREG_GAMMA_BASE(ViPipe) + 0x810 + (u16Index * sizeof(HI_U16))));
//}
//
//static __inline HI_VOID hi_ext_system_gamma_step_write(VI_PIPE ViPipe, HI_U16 u16Index, HI_U8 data)
//{
//    IOWR_8DIRECT(VREG_GAMMA_BASE(ViPipe) + 0x820 + (u16Index * sizeof(HI_U8)), data);
//}
//
//static __inline HI_U8 hi_ext_system_gamma_step_read(VI_PIPE ViPipe,  HI_U16 u16Index)
//{
//    return (IORD_8DIRECT(VREG_GAMMA_BASE(ViPipe) + 0x820 + (u16Index * sizeof(HI_U8))));
//}
