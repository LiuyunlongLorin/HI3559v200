...
static HI_S32 cmos_get_ae_default(VI_PIPE ViPipe, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
    ...
    switch (pstSnsState->enWDRMode)
    {
        ...
        case WDR_MODE_NONE:
        {
            ...
            pstAeSnsDft->u32MaxAgain = 15872 + 8192;/*Again+Dgain*/
                                       ...
                                       AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
    ...
    if (OV12870_FULL_LINES_MAX < u32FullLines)
    {
        ...
        pstSnsState->astRegsInfo[0].astI2cData[9].u32Data = 0x1; //write 0x4202 0x1
...
#endif
    if (OV12870_8M_30FPS_10BIT_LINEAR_MODE == pstSnsState->u8ImgMode)
    {
        pstDef->unKey.bit1Lsc      = 1;
        pstDef->pstLsc             = &g_stCmosLsc_8M;
    }
    else if (OV12870_12M_30FPS_10BIT_LINEAR_MODE == pstSnsState->u8ImgMode)
    {
        pstDef->unKey.bit1Lsc      = 1;
        pstDef->pstLsc             = &g_stCmosLsc_12M;
    }
    else if (OV12870_2M_120FPS_10BIT_LINEAR_MODE == pstSnsState->u8ImgMode)
    {
        pstDef->unKey.bit1Lsc      = 1;
