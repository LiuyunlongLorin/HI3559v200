...
void imx307_2l_prog(VI_PIPE ViPipe, int *rom)
{
    int i = 0;
    while (1)
    {
        ...
        {
            imx307_2l_write_register(ViPipe, addr, data);
        }
    }
}
...
void imx307_2l_init(VI_PIPE ViPipe)
{
    ...
    bInit       = g_pastImx307_2l[ViPipe]->bInit;
...
void imx307_2l_linear_1080p30_init(VI_PIPE ViPipe)
{
    ...
    //imx307_2l_write_register(ViPipe, 0x3002, 0x01); // Master mode stop
    ...
    //imx307_2l_write_register(ViPipe, 0x300C, 0x00);
    //imx307_2l_write_register(ViPipe, 0x3010, 0x21);
    imx307_2l_write_register(ViPipe, 0x3011, 0x0A);
    //imx307_2l_write_register(ViPipe, 0x3014, 0x00);    // gain
    ...
    //imx307_2l_write_register(ViPipe, 0x3020, 0x01);    // SHS1
    //imx307_2l_write_register(ViPipe, 0x3021, 0x00);    // SHS1
    //imx307_2l_write_register(ViPipe, 0x3022, 0x00);    // SHS1
    //imx307_2l_write_register(ViPipe, 0x3024, 0x00);    // SHS2
    //imx307_2l_write_register(ViPipe, 0x3025, 0x00);    // SHS2
    //imx307_2l_write_register(ViPipe, 0x3026, 0x00);    // SHS2
    //imx307_2l_write_register(ViPipe, 0x3030, 0x0B);    // RHS1
    //imx307_2l_write_register(ViPipe, 0x3031, 0x00);    // RHS1
    //imx307_2l_write_register(ViPipe, 0x3032, 0x00);    // RHS1
    //imx307_2l_write_register(ViPipe, 0x3045, 0x01);
    ...
    //imx307_2l_write_register(ViPipe, 0x3106, 0x00);
    ...
    //imx307_2l_write_register(ViPipe, 0x3002, 0x00);    // master mode start
    //imx307_2l_write_register(ViPipe, 0x304B, 0x0a);    // XVSOUTSEL XHSOUTSEL enable output
    //usleep(20000);
...
void imx307_2l_wdr_1080p30_2to1_init(VI_PIPE ViPipe)
{
    ...
    imx307_2l_write_register(ViPipe, 0x3021, 0x00); //# SHS1
    //imx307_2l_write_register(ViPipe, 0x3022, 0x00); //#
    imx307_2l_write_register(ViPipe, 0x3024, 0x49); //# SHS2
    imx307_2l_write_register(ViPipe, 0x3025, 0x08); //# SHS2
    //imx307_2l_write_register(ViPipe, 0x3026, 0x00); //#
    imx307_2l_write_register(ViPipe, 0x3030, 0x0B); //# RHS1
    imx307_2l_write_register(ViPipe, 0x3031, 0x00); //# RHS1
    //imx307_2l_write_register(ViPipe, 0x3032, 0x00); //#
    //imx307_2l_write_register(ViPipe, 0x303A, 0x08); //#
    //imx307_2l_write_register(ViPipe, 0x303C, 0x04); //# WINPV
    //imx307_2l_write_register(ViPipe, 0x303D, 0x00); //#
    //imx307_2l_write_register(ViPipe, 0x303E, 0x41); //# WINWV
    //imx307_2l_write_register(ViPipe, 0x303F, 0x04); //#
    ...
    //imx307_2l_write_register(ViPipe, 0x3002, 0x00); //#
    //imx307_2l_write_register(ViPipe, 0x304b, 0x0a); //#
